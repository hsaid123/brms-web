...
@WebServiceClient(name = "BPMNWebService", 
                  wsdlLocation = "http://localhost:8080/brms-webservices-test/bpmn-service?wsdl",
...
public class BPMNWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/brms-webservices-test/bpmn-service?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/brms-webservices-test/bpmn-service?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
